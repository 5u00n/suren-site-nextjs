...
export const InfiniteMovingCards = ({
  ...
  return (
    (<div
      ref={containerRef}
      className={cn(
        "scroller relative z-20  lg:max-w-[1280px] md:max-w-[768px] sm:max-w-[640px] xs:max-w-[320px] overflow-hidden  [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className
      )}>
      <ul
        ref={scrollerRef}
